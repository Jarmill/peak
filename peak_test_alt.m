...
%        legend({'Initial Set', 'Safety Margin', 'Trajectories', 'Peak Traj.'}, 'location', 'northwest')
        ...
        if LINE_COST 
            ...
            if ISOSURFACE
                legend({'Initial Set', 'Unsafe Set', 'Safety Margin', 'Safety Contour', 'Trajectories', 'Peak Traj.'}, 'location', 'northwest')
            else
                legend({'Initial Set', 'Unsafe Set', 'Safety Margin', 'Trajectories', 'Peak Traj'}, 'location', 'northwest')
            end
        end
        ...
        if LINE_COST
            ...
            if ISOSURFACE
                legend({'Initial Set', 'Unsafe Set', 'Safety Margin', 'Safety Contour', 'Trajectories'}, 'location', 'northwest')
            else
                legend({'Initial Set', 'Unsafe Set', 'Safety Margin', 'Trajectories'}, 'location', 'northwest')
            end
        end
